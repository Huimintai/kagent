...
import (
	...
	"github.com/kagent-dev/kagent/go/core/cli/internal/cli/platform"
...
Examples:
  ...
  kagent run .`,
	...
	rootCmd.AddCommand(installCmd, uninstallCmd, invokeCmd, bugReportCmd, versionCmd, dashboardCmd, getCmd, initCmd, buildCmd, deployCmd, addMcpCmd, runCmd, mcp.NewMCPCmd(), envdoc.NewEnvCmd(), platform.NewPlatformCmd())
