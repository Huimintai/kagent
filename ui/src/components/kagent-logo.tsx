  ...
  return (
    <>
      ...
      <svg width={378} height={286} viewBox="0 0 378 286" fill="none" xmlns="http://www.w3.org/2000/svg" className={className}>
        <path d="M283.198 143.037H236.099V190.438H283.198V143.037Z" fill="#0070F2" style={rightEyeStyle} />
        <path d="M189.074 143.037H141.975V190.438H189.074V143.037Z" fill="#0070F2" style={leftEyeStyle} />
        <path
