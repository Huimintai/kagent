...
export async function GET() {
  ...
  return NextResponse.json({
    ...
    disableDashboard: envBool("KAGENT_DISABLE_DASHBOARD", "NEXT_PUBLIC_DISABLE_DASHBOARD", false),
    disableComments: envBool("KAGENT_DISABLE_COMMENTS", "NEXT_PUBLIC_DISABLE_COMMENTS", false),
    dashboardExcludePattern: envString("KAGENT_DASHBOARD_EXCLUDE_PATTERN", "NEXT_PUBLIC_DASHBOARD_EXCLUDE_PATTERN", ""),
