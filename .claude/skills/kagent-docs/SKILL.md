...
| Level | Files | Scope |
|-------|-------|-------|
| L0 | `CLAUDE.md` | Developer conventions, project structure |
| L1 | `docs/platform-overview.md`, `docs/getting-started.md` | Architecture, onboarding |
| L2 | `docs/guides/*.md` | How-to guides (agents, models, tools, skills, memory) |
| L3 | `docs/agents/*.md` | Specific agent documentation |
| L4 | `docs/internal/*.md` | Internal implementation notes |
...
|-----------|----------------------|
| `go/api/v1alpha2/` | `docs/guides/creating-agents.md`, `docs/guides/models.md`, `docs/platform-overview.md` |
| `go/core/internal/httpserver/` | `docs/guides/tools-and-mcp-servers.md`, API usage in guides |
| `go/core/internal/controller/` | `docs/platform-overview.md` |
| `go/adk/` | `docs/guides/creating-agents.md` |
| `helm/` | `docs/getting-started.md`, `CLAUDE.md` |
| `ui/` | `docs/guides/*.md` (user-facing features) |
| `python/` | `docs/guides/creating-agents.md`, `docs/guides/memory.md` |
| Auth-related (`oidc`, `auth`, `credential`) | `docs/identity-and-access.md` |
| `deploy.sh`, `scripts/build/`, `scripts/` | `CLAUDE.md` (quick reference section) |
| New CRDs or controllers | `docs/platform-overview.md`, potentially new guide |
...
| Doc | Status | Issue |
|-----|--------|-------|
| docs/guides/creating-agents.md | STALE | Missing codexConfig documentation |
| docs/platform-overview.md | OK | — |
| CHANGELOG.md | STALE | Missing ScheduledRun feature |
```
...
- No references to deleted features (v1alpha1, MCPServer KMCP, CrewAI)
